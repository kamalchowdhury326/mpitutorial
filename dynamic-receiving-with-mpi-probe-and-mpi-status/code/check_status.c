...
int main(int argc, char** argv) {
  ...
  if (world_rank == 0) {
    ...
    printf("0 sent %d numbers to 1 with numbers[0]=%d\n", number_amount,numbers[0]);
    ...
    printf("1 received %d numbers from 0. Message source = %d, tag = %d with numbers[0]=%d\n",
           number_amount, status.MPI_SOURCE, status.MPI_TAG,numbers[0]);
  }
